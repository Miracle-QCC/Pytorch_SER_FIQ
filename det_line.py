...
if __name__ == "__main__":
    ...
    parser.add_argument("--input_path",default="test1.jpg", help="path to image or to foulder with images")
    parser.add_argument("--out_path",default=".", help="output foulder")
    parser.add_argument("--model_path",default="./model.onnx", help="Neural network name to use in detection")
